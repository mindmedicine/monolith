...
| Dynamic inputs | 9 | `add_dynamic_input`, `insert_dynamic_input` (**disabled — always refuses**), `set_dynamic_input_value`, `search_dynamic_inputs`, `list_dynamic_inputs`, `get_dynamic_input_tree`, `remove_dynamic_input`, `get_dynamic_input_value`, `get_dynamic_input_inputs` |
